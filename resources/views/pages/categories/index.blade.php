    ...
    <main class="ml-64 flex-1 p-8">
        ...
        <div class="flex items-center justify-between mb-8">
            <div>
                ...
                <p class="text-sm text-gray-500 mt-0.5">Manage your product categories</p>
            </div>
        ...
        <div class="bg-white rounded-2xl border border-gray-100 shadow-sm">
            ...
            <div class="flex items-center justify-between px-6 py-4 border-b border-gray-50">
                ...
                <span class="text-xs text-gray-400 font-medium">{{ $categories->count() }}
                    {{ Str::plural('category', $categories->count()) }}</span>
            </div>
            ...
            <div class="p-6">
                @if ($categories->isEmpty())
                    ...
                    <div class="text-center py-16">
                        ...
                        <p class="text-xs text-gray-400 mt-1">Click "New Category" to get started</p>
                    </div>
                @else
                    <div class="grid grid-cols-1 gap-5">

                        {{-- Column 1: items 1–8 --}}
                        @if ($categories->slice(0, 8)->isNotEmpty())
                                            ...
                                            <tr class="hover:bg-gray-50 transition table-row"
                                                ...
                                                <td class="px-4 py-3 text-center">
                                                    @if ($category->is_active)
                                                        <span
                                                            class="inline-block text-xs bg-green-50 text-green-600 px-2.5 py-0.5 rounded-full font-medium">Active</span>
                                                    @else
                                                        <span
                                                            class="inline-block text-xs bg-gray-100 text-gray-400 px-2.5 py-0.5 rounded-full font-medium">Inactive</span>
                                                    @endif
                                                </td>
   ...
   title="Edit">
    ...
    <svg width="14" height="14" viewBox="0 0 24 24"
        ...
        <path d="M18.5 2.5a2.121 2.121 0 013 3L12 15l-4 1 1-4 9.5-9.5z"/>
                        ...
                        {{-- Column 2: items 9+ --}}
                        @if ($categories->slice(8)->isNotEmpty())
                            <div class="rounded-xl border border-gray-100 overflow-hidden">
                                <table class="w-full text-sm" id="table2">
                                    <thead>
                                        <tr class="bg-gray-50 text-xs text-gray-400 font-semibold uppercase tracking-wide">
                                            <th class="px-4 py-3 text-left">Name</th>
                                            <th class="px-4 py-3 text-left">Description</th>
